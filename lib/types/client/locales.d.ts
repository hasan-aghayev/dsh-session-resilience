...
export declare const zh: {
    ...
    'field.enabledHint': string;
    'field.restartAutoContinue': string;
    'field.restartAutoContinueHint': string;
    'field.restartResumeWindowMs': string;
    'field.restartResumeWindowMsHint': string;
    'field.recoveryPreset': string;
    'field.recoveryPresetHint': string;
    'preset.safe': string;
    'preset.balanced': string;
    'preset.longTask': string;
    'preset.manual': string;
    'restart.label': string;
    'restart.restart': string;
    'restart.shutdown': string;
    'restart.online': string;
    'restart.offline': string;
    'restart.checking': string;
    'restart.restarting': string;
    'restart.shuttingDown': string;
    'restart.reloadHint': string;
    'restart.restartFailed': string;
    'restart.shutdownFailed': string;
