...
export declare const AutoContinueSchema: z<Schemastery.ObjectS<{
    ...
    recoveryPreset: z<"manual" | "safe" | "balanced" | "long-task", "manual" | "safe" | "balanced" | "long-task">;
    ...
    restartAutoContinue: z<boolean, boolean>;
    /** How long a recorded restart handoff remains valid for a browser reconnect. */
    restartResumeWindowMs: z<number, number>;
